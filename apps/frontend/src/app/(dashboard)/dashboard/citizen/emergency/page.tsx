...
import { AlertCircle, Phone, MapPin, Clock, Save, Edit, Loader2, UserPlus } from 'lucide-react'
import { useEmergencyContactQuery, useSaveEmergencyContactMutation } from '@/lib/graphql/hooks/user.hooks'
...
export default function EmergencyPage() {
  ...
  const { data, loading: loadingContact, error, refetch } = useEmergencyContactQuery({
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        {loadingContact ? (
          ...
          <div className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label htmlFor="contactName" className="text-blue-900 dark:text-blue-100">Name</Label>
                <Input
                  id="contactName"
                  value={formData.name}
              ...
              <div>
                <Label htmlFor="contactPhone" className="text-blue-900 dark:text-blue-100">Phone</Label>
                <Input
                  id="contactPhone"
            ...
            <div>
              <Label htmlFor="contactRelationship" className="text-blue-900 dark:text-blue-100">Relationship</Label>
              <Input
          ...
          <div className="p-4 bg-white dark:bg-gray-900 rounded-lg">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-blue-800 dark:text-blue-200">
                ...
                <a href={`tel:${emergencyContact.phone}`} className="hover:underline">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="p-6 border-orange-200 bg-orange-50 dark:border-orange-900 dark:bg-orange-950">
          <div className="flex items-start gap-4">
      ...
      {/* Nearest Hospitals */}
      <Card className="p-6">
        <h2 className="text-2xl font-semibold mb-4">Nearest Hospitals with Anti-Venom</h2>
        ...
        <div className="space-y-3">
          <div className="p-4 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Distance: 2.5 km</p>
          ...
          <div className="p-4 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Distance: 4.1 km</p>
            <Button variant="outline" size="sm" className="mt-2">
              <MapPin className="mr-2 h-4 w-4" />
              Get Directions
            </Button>
