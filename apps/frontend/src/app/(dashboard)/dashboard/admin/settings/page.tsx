...
export default function AdminSettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'general' | 'notifications' | 'coverage' | 'integrations' | 'security'
  >('general');
  ...
  const tabs: Array<{
    id: 'general' | 'notifications' | 'coverage' | 'integrations' | 'security';
    label: string;
    icon: any;
  }> = [
        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      defaultRadius: parseInt(e.target.value) || 0,
                    })
                  }
                />
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              {['Butwal', 'Bhairahawa', 'Pokhara', 'Kathmandu', 'Chitwan'].map(
                (zone) => (
                  <div
                    key={zone}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, mapboxToken: e.target.value })
                  }
                />
              </div>
            </div>
