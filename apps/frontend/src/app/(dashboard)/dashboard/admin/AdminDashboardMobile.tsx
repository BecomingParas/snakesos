              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Manage active operations</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Track rescuers in real-time</p>
                  </div>
                </div>
                <ChevronRight className="h-5 w-5 text-muted-foreground" />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">View team availability</p>
                  </div>
                </div>
                <ChevronRight className="h-5 w-5 text-muted-foreground" />
              </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <Card className="p-3">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[10px] text-muted-foreground leading-tight">Released Safely</p>
              </div>
            </Card>
            ...
            <Card className="p-3">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[10px] text-muted-foreground leading-tight">Verified Rescuers</p>
              </div>
            </Card>
            ...
            <Card className="p-3">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[10px] text-muted-foreground leading-tight">Completion Rate</p>
              </div>
            </Card>
          </div>
        </div>
...
function ActivityItem({ icon, text, time, tone }: ActivityItemProps) {
  ...
  return (
    <div className="flex items-start gap-3 p-3">
      <div className={cn('h-8 w-8 rounded-full flex items-center justify-center shrink-0', toneClass[tone])}>
        {icon}
      </div>
