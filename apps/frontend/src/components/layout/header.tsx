      ...
      <div className="mx-auto flex h-[72px] max-w-[1400px] items-center gap-4 px-2 sm:px-5">
        <Link href="/" className="flex items-center gap-1 group">
          ...
          <img
            ...
            alt="SnakeSOS Logo"
            className="h-16 w-48 sm:h-16 sm:w-48 lg:h-48 lg:w-48 object-contain transition-transform group-hover:scale-105 dark:hidden"
          />
          {/* Dark mode logo */}
          <img
            src="/snakesoslogo_bg.png"
            alt="SnakeSOS Logo"
            className="hidden h-16 w-48 sm:h-16 sm:w-48 lg:h-48 lg:w-48 object-contain transition-transform group-hover:scale-105 dark:block"
          />
        </Link>
