    ...
    <div className="bg-gradient-to-b from-background via-primary/5 to-background border-t border-border/20">
      <div className="mx-auto max-w-[1400px] px-5 py-20 lg:py-28">
        <div className="flex items-end justify-between gap-4">
          ...
          <Button asChild variant="outline" className="hidden sm:flex hover:border-primary/50 transition-all">
              ...
              <div className="relative">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className={cn("text-[10px] font-bold uppercase tracking-wider", urgencyColors[rescue.urgency])}
                    >
                      {rescue.urgency}
                    </Badge>
                    <Badge
                      variant="outline"
                      className={cn("text-[10px] font-bold uppercase tracking-wider", statusColors[rescue.status])}
                    >
                ...
                {/* Species */}
                <h3 className="mt-4 text-xl font-bold text-foreground">{rescue.species}</h3>
                ...
                {/* Notes */}
                <p className="mt-4 text-sm text-muted-foreground leading-relaxed">{rescue.notes}</p>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-3">
          <div className="group relative overflow-hidden rounded-xl border border-border/30 bg-background/60 p-7 backdrop-blur-xl shadow-md hover:shadow-lg hover:border-primary/30 transition-all">
            ...
            <div className="relative">
              ...
              <h3 className="text-lg font-bold text-foreground">Triage in seconds</h3>
          ...
          <div className="group relative overflow-hidden rounded-xl border border-border/30 bg-background/60 p-7 backdrop-blur-xl shadow-md hover:shadow-lg hover:border-primary/30 transition-all">
            ...
            <div className="relative">
              ...
              <h3 className="text-lg font-bold text-foreground">Ready responders</h3>
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="group relative overflow-hidden rounded-xl border border-border/30 bg-background/60 p-7 backdrop-blur-xl shadow-md hover:shadow-lg hover:border-primary/30 transition-all">
            ...
            <div className="relative">
              <div className="mb-4 grid h-12 w-12 place-items-center rounded-xl bg-accent/10 text-accent shadow-sm">
