              ...
              {collapsed ? (
                ...
                <>
                  ...
                  <img
                    ...
                    alt="SnakeSOS Logo"
                    className="hidden h-16 w-auto sm:h-16 sm:w-auto lg:h-20 lg:w-auto max-w-full object-contain transition-all duration-300 group-hover:scale-110 dark:block"
                  />
                </>
              )}
            </Link>
