...
export function MobileDrawer({ open, onClose, role, user, onLogout }: MobileDrawerProps) {
  const router = useRouter()
  const pathname = usePathname()

  // Role-specific configuration
  const roleConfig: Record<string, { title: string; subtitle: string; basePath: string; links: NavLink[] }> = {
    CITIZEN: {
      title: 'Citizen',
